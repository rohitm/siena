...
const getBittrexMarketHistory = market => new Promise(async (resolveHistory, rejectHistory) => request(`https://bittrex.com/api/v1.1/public/getmarkethistory?market=${market}`, (error, response, body) => {
  if (error) {
